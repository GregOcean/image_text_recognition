...
class OcrData():
    ...
    total images = 78905
    WINDOWS:
    -- folder_labels='E:/1_MachineLearning/Chars74K/ImageTree'
    -- folder_data='E:/1_MachineLearning/Chars74K/'
    """
...
###########################################################################################################################################
    ...
    def merge_with_cifar(self):
        ...
        """ 
        cifar = Cifar('E:/1_MachineLearning/ImageTextRecognition-master/cifar-config.py')
        
        text = OcrData('E:/1_MachineLearning/ImageTextRecognition-master/text-config.py')
        ...
        for c in [0.01, 0.1, 1, 2, 10]:
            ...
            clf = Pipeline([
                            ('convnet', ConvNetFeatures(
                                        pretrained_params='E:\1_MachineLearning\Kaggle-Cifar10\CatsDogs\imagenet.decafnet.epoch90',
                                        pretrained_meta='E:\1_MachineLearning\Kaggle-Cifar10\CatsDogs\imagenet.decafnet.meta',
                                        )), 
                            ('clf', LinearSVC(C=c))])
